...
*/
class QAjTab : public QTabWidget
{
Q_OBJECT
public:
    QAjTab( QString* filesystemSeparator, QAjIcons *icons, bool special, QWidget *parent = 0, const char *name = 0);
	...
	bool oneSelected( QTreeWidget* list );
private:
	bool special;
};
