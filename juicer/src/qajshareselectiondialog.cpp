...
QAjShareSelectionDialog::QAjShareSelectionDialog(QXMLModule* xml, QWidget* parent, Qt::WFlags fl)
...
/*!
    \fn QAjShareSelectionDialog::updateSubDirectoriesSlot(QTreeWidgetItem* item)
 */
void QAjShareSelectionDialog::updateSubDirectoriesSlot(QTreeWidgetItem* item) {
...
/*!
    \fn QAjShareSelectionDialog::getPath(QTreeWidgetItem* item)
 */
QString QAjShareSelectionDialog::getPath(QTreeWidgetItem* item) {
    QString path = "";
    while(item != NULL) {
...
/*!
    \fn QAjShareSelectionDialog::selectedPath()
 */
QString QAjShareSelectionDialog::selectedPath() {
